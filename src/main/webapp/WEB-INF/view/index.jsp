...
<body class="presentation-page ">
    ...
    <div class="page-header header-filter clear-filter" data-parallax="true" style="background-image: url(&quot;https://demos.creative-tim.com/marketplace/material-kit-pro/assets/img/kit/pro/bg0.jpg&quot;); transform: translate3d(0px, 0px, 0px);">
        <div class="container">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-12">
                        <h3 class="title">Basic Components
                            </h3><h6 class="description">The core elements of your website</h6>
            ...
            <div class="container">
                <div class="col-md-8 ml-auto mr-auto">
                    <div class="section-description">
                        ...
                        <a href="sections.html" class="btn btn-rose btn-round">View All Sections</a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <div class="section-description">
                            ...
                            <a href="https://github.com/creativetimofficial/material-kit" class="btn btn-rose btn-round">View Demo on Github</a>
            ...
            <div class="section-testimonials team-3">
                <div class="container">
                            ...
                            <div class="card card-profile card-plain">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="card-header card-header-image">
                                            <a href="#pablo">
                                                <img class="img" src="assets/assets-for-demo/testimonials/test3.jpg">
                                            </a>
                                            <div class="colored-shadow" style="background-image: url(&quot;assets/assets-for-demo/testimonials/test3.jpg&quot;); opacity: 1;"></div>
                                        <div class="colored-shadow" style="background-image: url(&quot;https://demos.creative-tim.com/marketplace/material-kit-pro/assets/assets-for-demo/testimonials/test3.jpg&quot;); opacity: 1;"></div></div>
                                    </div>
                                    <div class="col-md-9">
                                        <div class="card-body">
                    ...
                    <div class="our-clients">
                        <div class="row">
                            <div class="col-md-3">
                                <img src="assets/assets-for-demo/testimonials/vodafone.jpg" alt="">
                            </div>
                            <div class="col-md-3">
                                <img src="assets/assets-for-demo/testimonials/microsoft.jpg" alt="">
                            </div>
                            <div class="col-md-3">
                                <img src="assets/assets-for-demo/testimonials/harvard.jpg" alt="">
                            </div>
                            <div class="col-md-3">
                                <img src="assets/assets-for-demo/testimonials/stanford.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <footer class="footer">
        <div class="container">
            <a class="footer-brand" href="#material-kit">Material Kit PRO</a>
    ...
    <!--   Core JS Files   -->
    <script src="https://connect.facebook.net/signals/config/111649226022273?v=2.8.20&amp;r=stable" async=""></script><script async="" src="//connect.facebook.net/en_US/fbevents.js"></script><script type="text/javascript" async="" src="https://ssl.google-analytics.com/ga.js"></script><script src="./assets/js/core/jquery.min.js"></script>
    ...
    <script src="./assets/js/material-kit.min.js?v=2.0.2"></script>
